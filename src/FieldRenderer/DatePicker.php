...
class DatePicker extends AbstractFieldRenderer
{
    public function showToEdit()
    {
        ...
        $this->html .= '<script type="text/javascript">$(function(){ $(".datePicker_'.$this->fieldName.'").datepicker({dateFormat: \'yy-mm-dd\', changeMonth: true, changeYear: true, yearRange: \'1940:2017\'}); });</script>';
